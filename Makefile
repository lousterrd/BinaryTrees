...
HEADERS = BinaryNode.h BinaryNodeTree.h BinaryTreeInterface.h BinarySearchTree.h #List of all header files
SRCS = BinaryNode.cpp BinaryNodeTree.cpp BinarySearchTree.cpp proj3.cpp #List of all source files
